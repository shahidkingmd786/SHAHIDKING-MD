  ...
  const senderIsSudo = await isSudo(senderId);
        ...
        if (isBanned(senderId) && !userMessage.startsWith('.unban')) {
            ...
            if (Math.random() < 0.1) {
                await sock.sendMessage(chatId, {
                    text: '🛑 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗 : You’ve been officially blocked from commands. Talk to an admin.',
                    ...channelInfo
                });
            }
            return;
        ...
        if (isGroup && isAdminCommand) {
            ...
            if (
                ...
                if (!isSenderAdmin && !message.key.fromMe) {
                    await sock.sendMessage(chatId, {
                        text: '😈 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗 : Nice try, peasant. This button belongs to the kings and queens (admins).',
                        ...channelInfo
                    });
                    return;
                }
        ...
        if (isOwnerCommand) {
            ...
            if (!message.key.fromMe) {
                await sock.sendMessage(chatId, {
                    text: '❌ This command is for the legendary owner of 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗  only! 👑',
                    ...channelInfo
                });
                return;
            }
        ...
        switch (true) {
            case userMessage === '.simage': {
                ...
                if (quotedMessage?.stickerMessage) {
                    ...
                    await sock.sendMessage(chatId, { text: '🎯 Tip from 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗 : Just reply to any sticker with .simage and watch the magic happen ✨.', ...channelInfo });
                }
                break;
            }
            ...
            case userMessage.startsWith('.mute'):
                ...
                if (isNaN(muteDuration)) {
                    await sock.sendMessage(chatId, { text: '🕒 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗  Tip: Minutes must be valid! Try: .mute 10\neg to mute 10 minutes\n.mute 10', ...channelInfo });
                } else {
            ...
            case userMessage.startsWith('.mode'):
                ...
                if (!message.key.fromMe) {
                    await sock.sendMessage(chatId, { text: '🚫 Access denied! Only the boss of 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗  can use this. 💼', ...channelInfo });
                    return;
                }
                ...
                try {
                    ...
                    await sock.sendMessage(chatId, { text: `🔄 Mode updated — 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗  is now in *${action}* mode.`, ...channelInfo });
                } catch (error) {
            ...
            case userMessage.startsWith('.antilink'):
                if (!isGroup) {
                    await sock.sendMessage(chatId, {
                        text: '🏠 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗 : This command works only inside groups.',
                        ...channelInfo
                    });
                    return;
                }
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, {
                        text: '⚠️𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗 : Make me an admin first so I can do my magic. 🪄',
                        ...channelInfo
                    });
                    return;
                }
...
case userMessage === '.alive':
    ...
    break;
           ...
           // .detect
            ...
            case userMessage === '.Pathansupport':
         ...
         // .explode
            ...
            case userMessage.startsWith('.move'):
                ...
                if (isNaN(position)) {
                    await sock.sendMessage(chatId, { text: '🕹 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗  says: That’s not a valid position! Pick a real one.', ...channelInfo });
                } else {
            ...
            case userMessage.startsWith('.answer'):
                ...
                if (answer) {
                    ...
                    sock.sendMessage(chatId, { text: '💬 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗 : Provide your answer using .answer <answer>', ...channelInfo });
                }
                break;
           ...
           //     await aliveCommand(sock, chatId, message);
            ...
            case userMessage.startsWith('.welcome'):
                if (isGroup) {
                    ...
                    await sock.sendMessage(chatId, { text: '🏠 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗 : This command can only be used inside groups...', ...channelInfo });
                }
                break;
            ...
            case userMessage.startsWith('.antibadword'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, { text: '*👑 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗  admin powers before trying this!*', ...channelInfo });
                    return;
                }
            ...
            case userMessage.startsWith('.chatbot'):
                if (!isGroup) {
                    await sock.sendMessage(chatId, { text: '👥 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗  says: You gotta be in a group to run this..', ...channelInfo });
                    return;
                }
                ...
                if (!chatbotAdminStatus.isSenderAdmin && !message.key.fromMe) {
                    await sock.sendMessage(chatId, { text: '*𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗 : Only group admins or the bot owner can use this command. 👑*', ...channelInfo });
                    return;
                }
     ...
     //           break;
            ...
            case userMessage === '.groupinfo' || userMessage === '.infogp' || userMessage === '.infogrupo':
                if (!isGroup) {
                    await sock.sendMessage(chatId, { text: '👥 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗  says: You must be in a group to use this.', ...channelInfo });
                    return;
                }
            ...
            case userMessage === '.resetlink' || userMessage === '.revoke' || userMessage === '.anularlink':
                if (!isGroup) {
                    await sock.sendMessage(chatId, { text: '👥 PATHAN BOT says: You must be in a group to use this.', ...channelInfo });
                    return;
                }
                ...
                async function groupJidCommand(sock, chatId, message) {
                    ...
                    if (!groupJid.endsWith('@g.us')) {
                        return await sock.sendMessage(chatId, {
                            text: "👥 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗  says: You must be in a group to use this."
                        });
                    }
        ...
        if (chatId) {
            await sock.sendMessage(chatId, {
                text: '💥 Error! 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗  couldn’t complete your request.',
                ...channelInfo
            });
        }
    }
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const welcomeMessage = welcomeData?.message || '👑 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗 : Hail {user}! The group just got cooler with you here!';
